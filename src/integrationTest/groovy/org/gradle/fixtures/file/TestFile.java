...
import org.gradle.fixtures.RetryUtil;
...
import static org.gradle.internal.impldep.org.junit.Assume.assumeTrue;
...
public class TestFile extends File {
    ...
    public TestFile java(@Language("java") String src) {
        assertTrue(getName() + " doesn't look like a Java file.", getName().endsWith(".java"));
        return setText(src);
    }
